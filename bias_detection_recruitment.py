...
# Introduce bias in hiring: Males have slightly higher chance
prob_hire = 0.2 + 0.1 * (gender == 0) + 0.05 * (experience_years / 10) + 0.1 * (education_level == 'Masters') + 0.15 * (education_level == 'PhD')
